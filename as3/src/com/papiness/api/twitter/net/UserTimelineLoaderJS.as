package com.papiness.api.twitter.net 
{
	...
	*/
	 ...
	 * @author daniwell
	 */
	public class UserTimelineLoaderJS extends EventDispatcher
	{
		 ...
		 */
		public function UserTimelineLoaderJS ( info :LoaderInfo = null ) 
		{
			_isLocal = false;
		...
		public function load ( id :String, param :Object = null ) :void
		{
			...
			{
				ExternalInterface.call( "getUserTimeLine", id, param );
			}
		}
		...
		/**
		 * SWFを埋め込むタグの id を設定します。
		 * @param	value	SWFを埋め込むタグの id。
		 */
		public function setFlashName ( value :String ) :void
		{
			ExternalInterface.call( "flashName", value );
		}
		...
		{
			ExternalInterface.addCallback("sendData", dataReceived);
		}
		
		/* JS COMPLETE */
		private function dataReceived ( obj :Object ) :void
		{
			parseObject( obj );
